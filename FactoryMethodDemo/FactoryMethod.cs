...
namespace FactoryMethodDemo
{
    abstract class Transport
    {
        ...
        public string LogisticOperactions()
        {
            Console.WriteLine("Creating instance of FactoryMethod");
            var package = FactoryMethod();
            Console.WriteLine("Delivering package has started");
            var result = package.DeliverPackage();

            return "Package is delivered: " + result;
        }
    }
    ...
    class Client
    {
        ...
        {
            Console.WriteLine("Started using transport " +transport.GetType().ToString());
            Console.WriteLine(transport.LogisticOperactions());
        }
    }
}
